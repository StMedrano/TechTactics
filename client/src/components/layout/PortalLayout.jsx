...
const navByRole = {
  customer: [
    ...
    { to: '/portal/customer/services', label: 'My Services', icon: 'services' },
    { to: '/portal/customer/request-help', label: 'Request Assistance', icon: 'tickets' },
  ...
  employee: [
    ...
    { to: '/portal/employee/jobs', label: 'My Jobs', icon: 'dispatch' },
  ...
  admin: [
    ...
    { to: '/portal/admin/jobs', label: 'My Dispatches', icon: 'dispatch' },
    { to: '/portal/admin/users', label: 'Users & Roles', icon: 'users' },
    { to: '/portal/admin/employees', label: 'Employees', icon: 'employees' },
    { to: '/portal/admin/tickets', label: 'Service Tickets', icon: 'tickets' },
